...
We recommend using the SAP Credential Store documentation on SAP Help Portal as a starting point for contributions:

1. Open the [SAP Credential Store documentation](https://help.sap.com/docs/credential-store/sap-credential-store/sap-credential-store?version=Cloud).
1. You can either:
